...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "fallbackExclusionList": [
      ["hinge-co-dating-analysis", ["workspace:."]]
    ],
    "fallbackPool": [
    ],
    "packageRegistryData": [
      ...
      ["plotly", [
        ["npm:1.0.6", {
          "packageLocation": "./.yarn/cache/plotly-npm-1.0.6-25dd3a3906-218b0babfd.zip/node_modules/plotly/",
          "packageDependencies": [
            ["plotly", "npm:1.0.6"],
            ["mkdirp", "npm:0.5.5"]
          ],
